...
(function ($, window, document, undefined) {
  ...
  $(function () {
    ...
    // PJax bindings
    // =================
    if ($.support.pjax && GEO.enablePjax) {
    ...
    $document.on('click', '[data-action]', function(e) {
      ...
      switch(action) {
        ...
        case 'share-weibo':
          _openWindow(
            'http://service.weibo.com/share/share.php?title=' + encodeURIComponent(document.title) + '&url=' + encodeURIComponent(location.href),
            450, 300);
          break;
        case 'share-facebook':
          _openWindow(
